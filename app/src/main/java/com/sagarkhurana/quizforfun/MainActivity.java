...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        CardView cvAlfabeto = findViewById(R.id.cvAbercedario);
        CardView cvNumeros = findViewById(R.id.cvNumeros);
        ...
        cvAlfabeto.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(MainActivity.this,AbecedarioActivity.class));
            }
        });

        cvNumeros.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
